...
import {
  ...
  deleteCollection,
  deleteVideo,
} from "../store/actions/myPortfolio";
import {
...
const MyPortfolioScreen = ({ navigation }) => {
  ...
  const onShare = async () => {
    //creates a link to share a user's portfolio
    try {
  ...
  if (loading) {
          ...
          ListHeaderComponent={
            <View>
              <View style={styles.header}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate("ProfileForm", { portfolio: portfolio })
                  }
                >
                  <MaterialCommunityIcons
                    name="pencil-circle"
              ...
              <Spacer>
                <View style={styles.titleContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("AboutForm", { portfolio: portfolio })
                    }
                  >
                    <MaterialCommunityIcons
                      name="pencil-circle"
              ...
              {(portfolio.about ||
                portfolio.location ||
                portfolio.type ||
                portfolio.birthday) && <BioSection portfolio={portfolio} />}
              ...
              <Spacer>
                <View style={styles.titleContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("WorkForm", { portfolio: portfolio })
                    }
                  >
                    <MaterialCommunityIcons
                      name="pencil-circle"
            ...
            <View>
              ...
              >
                <View>
                  ...
                  <Button
                    ...
                    onPress={() => {
                      setIsVisible(false);
                      navigation.navigate("CollectionPhotosDelete", {
                        collection: selectedCollection,
                      });
                    }}
                  />
                ...
                <View>
                  <Button
                    ...
                    onPress={() => {
                      ...
                      navigation.navigate("VideosEdit", {
                        video: selectedVideo,
                      });
                    }}
                  />
              ...
              <Spacer>
                <View style={styles.titleContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() => navigation.navigate("TimelineForm")}
                  >
                    <MaterialCommunityIcons
                      name="pencil-circle"
                      size={35}
    ...
    return <CreateForm type="Create" btnType="Add" submitBtnTitle="Create" />;
  }
};
