    ...
    <Spacer>
      <View style={styles.profile}>
        ...
        <View style={styles.userInfo}>
          ...
          <TouchableOpacity
            onPress={() => navigation.push("Recommendations", { itemId: id })}
          >
          ...
          {btnType === "Recommend" && (
            <Button
              ...
              buttonStyle={
                recommending ? styles.recommending : styles.recommend
              }
              titleStyle={
                recommending ? styles.recommendingTitle : styles.recommendTitle
              }
              onPress={() => {
