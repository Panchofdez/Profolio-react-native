  ...
  mainFlow: createBottomTabNavigator(
    {
      portfoliosFlow: createStackNavigator(
        {
          ...
          PortfolioShow: {
            screen: PortfolioShowScreen,
            navigationOptions: portfolioHeaderStyle,
          },
          CommentForm: {
            screen: CommentFormScreen,
        ...
        },
        {
          navigationOptions: {
            tabBarIcon: ({ tintColor }) => (
              <FontAwesome5 name="search" size={30} color={tintColor} />
            ),
          },
        }
      ),
      notificationsFlow: createStackNavigator(
        ...
        },
        {
          navigationOptions: {
            tabBarIcon: ({ tintColor }) => (
              <NotificationIcon color={tintColor} />
            ),
          },
        }
      ),
      myPortfolioFlow: createStackNavigator(
        {
          ...
          CollectionPhotosDelete: {
            screen: CollectionPhotosDeleteScreen,
            navigationOptions: headerStyle,
          },
          VideosCreate: {
            screen: VideosCreateScreen,
            navigationOptions: headerStyle,
          },
          VideosEdit: {
            screen: VideosEditScreen,
            navigationOptions: headerStyle,
          },
          SkillsForm: {
            screen: SkillsFormScreen,
            navigationOptions: headerStyle,
          },
          ContactForm: {
          ...
          TimelineForm: {
            screen: TimelineFormScreen,
            navigationOptions: headerStyle,
          },
          TimelineEditForm: {
            screen: TimelineEditFormScreen,
            navigationOptions: headerStyle,
          },
        },
        {
          navigationOptions: {
            tabBarIcon: ({ tintColor }) => (
              <FontAwesome5 solid name="user" size={30} color={tintColor} />
            ),
          },
        }
      ),
